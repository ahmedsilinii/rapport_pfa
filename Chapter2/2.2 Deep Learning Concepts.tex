...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{rapport_pfa-main/images/Word Embedding Example.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1\textwidth]{rapport_pfa-main/images/RNN.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\textwidth]{rapport_pfa-main/images/Transformer Architecture.png}
